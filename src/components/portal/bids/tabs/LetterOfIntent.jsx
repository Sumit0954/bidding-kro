        ...
        <AccordionDetails>
          <div className={styles["loi-content"]}>
            <div className={styles["bid-Letter"]}>
              <Typography variant="h6" className={styles["bid-letter-contnet"]}>
            ...
            <Typography variant="h6"><strong>Next Steps</strong></Typography>
            <Typography>
              We request you to review the attached contract and provide your
              confirmation by the deadline. Once confirmed, the formal contract
              will be finalized and executed.
            </Typography>

            <Typography>
              For any modifications or queries, please contact [Contact Person]
              at [Email] or [Phone].
            </Typography>
          </div>
        </AccordionDetails>
